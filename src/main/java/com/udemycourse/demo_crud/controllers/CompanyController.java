package com.udemycourse.demo_crud.controllers;

import com.udemycourse.demo_crud.entities.Company;
import com.udemycourse.demo_crud.services.CompanyService;
...
public class CompanyController {
    ...
    @Operation(summary = "delete in DB a company given a company for name")
